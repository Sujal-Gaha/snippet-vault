...
:root, .stApp, [data-testid="stAppViewContainer"], [data-testid="stHeader"], [data-testid="stSidebar"] {
    --primary-color: $clr_primary !important;
    --background-color: $clr_bg !important;
    --secondary-background-color: $clr_sec_bg !important;
    --text-color: $clr_text !important;
    
    /* Streamlit specific variables to trigger theme colors on elements */
    --st-color-background: $clr_bg !important;
    --st-color-background-secondary: $clr_sec_bg !important;
