from ui.themes.nordic import NORDIC_THEMES
from ui.themes.rose import ROSE_THEMES
from ui.themes.catppuccin import CATPPUCCIN_THEMES
...
DEFAULT_THEMES.update(ROSE_THEMES)
DEFAULT_THEMES.update(CATPPUCCIN_THEMES)
