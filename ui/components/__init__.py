from ui.components.components import SnippetUIRenderer
...
from ui.components.dialogs import add_snippet_dialog, view_snippet_dialog, edit_snippet_dialog, theme_gallery_dialog, shortcuts_dialog
